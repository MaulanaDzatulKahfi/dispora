...
@section('content')
    <div class="bg-green-600 p-4 shadow text-xl text-white">
        <h3 class="font-bold pl-2">
            <a href="{{ route('perting.index') }}">{{ $perting->name }}</a> / <a href="{{ route('jurusan.index', $perting->id) }}">Jurusan</a>
        </h3>
    </div>
    ...
    <div class="container w-full mx-auto px-2 mt-4">
        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            <div class="flex mb-2">
                <a href="{{ route('jurusan.create', $perting->id) }}" class="bg-green-600 text-white p-2 rounded-md hover:bg-green-700">tambah</a>
            </div>
